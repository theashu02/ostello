...
//           the NEET 2025 syllabus until the official 2026 syllabus is released.
//           The syllabus includes topics from Class 11 and 12 Physics, Chemistry,
...
//           (OMR-based), and candidates will mark their answers on the OMR sheet.
//           It will consist of 180 compulsory multiple-choice questions (MCQs)
//           divided across three subjects: Physics (45 questions), Chemistry (45
//           questions), and Biology (90 questions, with 45 each from Botany and
//           Zoology).
//         </p>
//         <p className="text-justify mb-4">
//           The total duration of the exam will be 180 minutes (3 hours), with no
//           additional time provided. Each correct answer will earn 4 marks, while
//           1 mark will be deducted for each incorrect answer, and unattempted
//           questions will carry no marks. One key change for NEET UG is the
//           removal of Section B, which previously included optional questions.
//           This means that all 180 questions will be mandatory for candidates,
//           ensuring a uniform and fair exam experience for all.
//         </p>
...
//           </a>
//           , including age, educational qualifications, and nationality, to
//           appear for the exam. Make sure to check all requirements before
//           applying.
//         </p>
//         {/* Table: Eligibility */}
//         <div className="overflow-x-auto">
...
//         </h3>
//         <p className="text-justify mb-4">
//           The NEET UG 2026 exam is expected to be scheduled on the first Sunday
//           of May 2026 i.e., May 3, 2026. NTA will release the NEET official
//           Information Bulletin with the full exam schedule and important
//           details.
//         </p>
//         {/* Table: Exam Dates */}
//         <div className="overflow-x-auto">
...
//           with a valid photo ID is mandatory for entry into the examination
//           hall.
//         </p>
...
//           roll number and other required credentials. The result is important
//           for counselling and seat allocation in medical and dental colleges
//           across India. Candidates who qualify the exam by meeting the cut-off
//           criteria will be eligible to participate in the counselling process.
//         </p>
//       </div>
//     </>
//   );
